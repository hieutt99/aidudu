# Generated by Django 3.2.8 on 2021-11-05 15:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('card', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cards', to='api.card')),
        ...
        migrations.AddField(
            model_name='card',
            name='labels',
            field=models.ManyToManyField(through='api.CardLabel', to='api.Label'),
        ),
        migrations.AddField(
            model_name='card',
            name='list',
